...
@section('title')
  {{ $post->title }} - Laravel Blog Engine
@endsection

@section('header')
<header class="header text-white h-fullscreen pb-80" style="background-image: url(http://cms.test/storage/{{ $post->image }});" data-overlay="9">
        ...
        <div class="col-lg-8 mx-auto">
          ...
          <div id="disqus_thread"></div>
            ...
            *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
            ...
            s.src = 'https://laravel-blog-engine.disqus.com/embed.js';
